...
public class ATB_Official_Enrollment extends EvaluateOfficialTranscript{
	...
	public static void admissionsTile(WebDriver driver) {
		...
		driver.findElement(By.xpath("//div[contains(text(),'DORSEY SCHOOLS ROSEVILLE')]")).click();
		...
		driver.findElement(By.xpath(".//*[@id='ContentPlaceHolder1_LeadControl_txtPhoneSecondry']")).sendKeys("9999999998");
	...
	public static void preparingUserForEnrollmentUnderManage(WebDriver driver) throws InterruptedException {
		...
		driver.findElement(By.xpath(".//*[@id='select2-drop']/div/input")).sendKeys("ATB");
...
/*	public static void finalEnrollment(WebDriver driver) {
		
		driver.findElement(By.xpath(".//*[@id='form1']/div[3]/div[3]/div/div[2]/div/div[2]/div/div/a")).click();
		driver.findElement(By.xpath(".//*[@id='form1']/div[3]/div[3]/div/div[3]/div[3]/div[2]/a")).click();
